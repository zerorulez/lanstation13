...
//This proc draws out the inventory and places the items on it. tx and ty are the upper left tile and mx, your are the bottm right.
...
/obj/item/weapon/storage/attackby(obj/item/W as obj, mob/user as mob)
	...
	if(isrobot(user))
		if(isMoMMI(user))
			...
			to_chat(user, "<span class='notice'>You are a robot. No.</span>")
