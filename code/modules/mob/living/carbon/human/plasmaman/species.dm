...
/datum/species/plasmaman/equip(var/mob/living/carbon/human/H)
	...
	to_chat(H, "<span class='notice'>I am now running on plasma internals from the [H.s_store] in my [tank_slot_name].  You must breathe plasma in order to survive, and are extremely flammable.</span>")
