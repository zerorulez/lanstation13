...
/obj/item/weapon/p_folded/proc/canunfold(var/obj/item/weapon/p_folded/P, mob/user)
	...
	if(!user.is_holding_item(P))
		to_chat(user, "<span class='notice'>I'll need \the [src] in your hands to do that.</span>")
		return 0
	return 1
...
/*
//at last, your block at a rest, bereft of all mortal doubts, I have been enlightened, touched by the sage wisdom, your undying gratitude goes to Comic in this emotional moment
