...
/obj/machinery/wish_granter_dark/attack_hand(var/mob/living/carbon/human/user as mob)
	...
	if(chargesa <= 0)
		...
		to_chat(user, "I feel a dark stirring inside of the Wish Granter, something I want nothing of. your instincts are better than any man's.")
		return
		...
		switch(wish)
			if("Power")
				...
				to_chat(user, "The Wish Granter punishes me for your selfishness, claiming your soul and warping your body to match the darkness in your heart.")
				if (!(M_LASER in user.mutations))
					user.mutations.Add(M_LASER)
					to_chat(user, "\blue I feel pressure building behind your eyes.")
			...
			if("To Kill")
				to_chat(user, "<B>Your wish is granted, but at a terrible cost...</B>")
				to_chat(user, "The Wish Granter punishes me for your wickedness, claiming your soul and warping your body to match the darkness in your heart.")
				ticker.mode.traitors += user.mind
				user.mind.special_role = "traitor"
				var/datum/objective/hijack/hijack = new
				hijack.owner = user.mind
				user.mind.objectives += hijack
				to_chat(user, "<B>Your inhibitions are swept away, the bonds of loyalty broken, I am free to murder as I please!</B>")
				var/obj_count = 1
...
/mob/living/carbon/proc/immortality()
	...
	if(!C.stat)
		to_chat(C, "<span class='notice'>You are not dead yet!</span>")
		return
