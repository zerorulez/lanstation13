...
/mob/living/simple_animal/borer/proc/speed_increase()
	...
	if(channeling && !channeling_speed_increase)
		...
		to_chat(src, "I cease your efforts to elevate the performance of your host's [limb_to_name(hostlimb)].")
		channeling = 0
		...
		to_chat(src, "I begin to focus your efforts on elevating the performance of your host's [limb_to_name(hostlimb)].")
		channeling = 1
