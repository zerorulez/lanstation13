...
/obj/machinery/computer/mecha/Topic(href, href_list)
	...
	if(href_list["send_message"])
		var/obj/item/mecha_parts/mecha_tracking/MT = t_filter.getObj("send_message")
	...
	if(href_list["lockdown"])
		var/obj/item/mecha_parts/mecha_tracking/MT = t_filter.getObj("lockdown")
		var/obj/mecha/M = MT.in_mecha()
		if(M.state)
		...
		switch(alert("Are you sure? The exosuit will enter maintenance mode.","Transmit Beacon Lockdown Code","Yes","No"))
			...
			if ("No")
				to_chat(usr, "I have second thoughts.")
	if(href_list["shock"])
		switch(alert("Are you sure? This cannot be undone.","Transmit Beacon Self-Destruct Code","Yes","No"))
			if ("Yes")
				var/obj/item/mecha_parts/mecha_tracking/MT = t_filter.getObj("shock")
				var/obj/mecha/M = MT.in_mecha()
				MT.shock()
	...
	if(href_list["get_log"])
		var/obj/item/mecha_parts/mecha_tracking/MT = t_filter.getObj("get_log")
