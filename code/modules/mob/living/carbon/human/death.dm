...
/mob/living/carbon/human/death(gibbed)
	...
	if(B && B.controlling)
		to_chat(src, "<span class='danger'>Your host has died.  I reluctantly release control.</span>")
		to_chat(B.host_brain, "<span class='danger'>Just before your body passes, I feel a brief return of sensation.  I am now in control...</span>")
