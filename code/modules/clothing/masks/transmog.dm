/obj/item/clothing/mask/morphing
	name = "morphing mask"
	desc = "The mask doesn't really resemble anything, though it gives you an eerie and intense feeling nonetheless."
...
/obj/item/clothing/mask/morphing/amorphous
	name = "amorphous mask"
	desc = "I can't really tell what this is supposed to be modeled after."
...
/obj/item/clothing/mask/morphing/amorphous/New()
	...
	target_type = pick(existing_typesof(/mob/living/simple_animal) - existing_typesof(/mob/living/simple_animal/hostile/humanoid) - typesof(/mob/living/simple_animal/hostile/giant_spider/hunter/dead) - typesof(/mob/living/simple_animal/hostile/asteroid/hivelordbrood))
