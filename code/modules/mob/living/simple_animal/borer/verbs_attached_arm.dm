...
/mob/living/simple_animal/borer/proc/bone_sword()
	...
	if(channeling && !channeling_bone_sword)
		...
		to_chat(src, "I cease your efforts to sustain a blade of bone for your host.")
		channeling = 0
		...
		to_chat(src, "I begin to focus your efforts on sustaining a blade of bone for your host.")
		channeling = 1
...
/mob/living/simple_animal/borer/proc/bone_hammer()
	...
	if(channeling && !channeling_bone_hammer)
		...
		to_chat(src, "I cease your efforts to sustain a mass of bone for your host.")
		channeling = 0
		...
		if(hostlimb == LIMB_RIGHT_ARM)
			...
			if(host.get_held_item_by_index(GRASP_LEFT_HAND))
				...
				host.drop_item(host.get_held_item_by_index(GRASP_LEFT_HAND), force_drop = 1)
			host.put_in_l_hand(S)
		to_chat(src, "I begin to focus your efforts on sustaining a mass of bone for your host.")
		channeling = 1
...
/mob/living/simple_animal/borer/proc/bone_shield()
	...
	if(channeling && !channeling_bone_shield)
		...
		to_chat(src, "I cease your efforts to sustain a shield of bone for your host.")
		channeling = 0
		...
		if(hostlimb == LIMB_RIGHT_ARM)
			...
			if(host.get_held_item_by_index(GRASP_LEFT_HAND))
				...
				host.drop_item(host.get_held_item_by_index(GRASP_LEFT_HAND), force_drop = 1)
			host.put_in_l_hand(S)
		to_chat(src, "I begin to focus your efforts on sustaining a shield of bone for your host.")
		channeling = 1
...
/mob/living/simple_animal/borer/proc/bone_cocoon()
	...
	if(channeling && !channeling_bone_cocoon)
		...
		to_chat(src, "I begin to focus your efforts on sustaining a cocoon of bone for your host.")
		channeling = 1
...
/mob/living/simple_animal/borer/proc/repair_bone()
	...
	for(var/datum/organ/external/O in current_limb.children)
		if(O.is_broken())
			...
			to_chat(src, "<span class='notice'>I've repaired the bones in your host's [hostlimb == LIMB_RIGHT_ARM ? "right" : "left"] hand.</span>")
	...
	if(current_limb.is_broken())
		...
		to_chat(src, "<span class='notice'>I've repaired the bones in your host's [hostlimb == LIMB_RIGHT_ARM ? "right" : "left"] arm.</span>")
