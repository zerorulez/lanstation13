...
/obj/effect/rune/proc/convert()
	...
	for(var/mob/living/carbon/M in src.loc)
		...
		if(is_convertable_to_cult(M.mind) && !jobban_isbanned(M, "cultist"))//putting jobban check here because is_convertable uses mind as argument
			...
			to_chat(M, "<span class='sinister'>Your blood pulses. your head throbs. The world goes red. All at once I am aware of a horrible, horrible truth. The veil of reality has been ripped away and in the festering wound left behind something sinister takes root.</span>")
			to_chat(M, "<span class='sinister'>You shall assist your new compatriots in their dark dealings. Their goal is mine, and mine is theirs. I serve the Dark One above all else.I shall bring It back.</span>")
			...
			to_chat(M, "<span class='sinister'>Your blood pulses. your head throbs. The world goes red. All at once I am aware of a horrible, horrible truth. The veil of reality has been ripped away and in the festering wound left behind something sinister takes root.</span>")
			to_chat(M, "<span class='danger'>But I am able to force it out of your mind. I know the truth. There's something horrible out there, I must stop it and its minions at all costs.</span>")
			return 0
...
/obj/effect/rune/proc/drain()
	...
	"<span class='warning'>The blood starts flowing from the rune and into your frail mortal body. I feel... empowered.</span>", \
...
//		ticker.mode.cult |= corpse_to_raise.mind
	...
	to_chat(corpse_to_raise, "<span class='sinister'>Your blood pulses. your head throbs. The world goes red. All at once I am aware of a horrible, horrible truth. The veil of reality has been ripped away and in the festering wound left behind something sinister takes root.</span>")
	to_chat(corpse_to_raise, "<span class='sinister'>You shall assist your new compatriots in their dark dealings. Their goal is mine, and mine is theirs. I serve the Dark One above all else. Bring It back.</span>")
	return
		...
		if(istype(A,/mob/living/carbon) || istype(A,/mob/living/simple_animal))//carbon mobs and simple animals
			...
			if (cult_round && (M.mind == cult_round.sacrifice_target))
				if(cultsinrange.len >= 3)
					...
					ritualresponse += "I need more cultists to perform the ritual and complete your objective."
			else
				if(M.stat != DEAD)
					if(cultsinrange.len >= 3)
...
//MMI
			...
			if(N)//the MMI has a player's brain in it
				if(cult_round && (N.mind == cult_round.sacrifice_target))
					ritualresponse += "I need to place that brain back inside a body before you can complete your objective."
				else
					ritualresponse += "The Geometer of Blood accepts to destroy that pile of machinery."
					sacrificedone = 1
					invocation("rune_sac")
