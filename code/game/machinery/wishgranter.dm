/obj/machinery/wish_granter
	...
	var/charges = 1
	var/insisting = 0
	var/wish_whispers = list("I want the station to disappear.", "Humanity is corrupt, mankind must be destroyed.", "I want to be rich.", "I want to rule the world.", "I want to uncover the truth.", "I want immortality.", "I want to become a god.", "I want your valids.")
