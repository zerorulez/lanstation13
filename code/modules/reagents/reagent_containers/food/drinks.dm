...
/obj/item/weapon/reagent_containers/food/drinks/soda_cans/attack_self(mob/user as mob)
	if(!is_open_container())
		to_chat(user, "I pull back the tab of \the [src] with a satisfying pop.")
		flags |= OPENCONTAINER
...
/obj/item/weapon/reagent_containers/food/drinks/soda_cans/attackby(obj/item/weapon/W, mob/user)
	..()
	if(iswirecutter(W))
		to_chat(user, "I cut out the top and bottom of \the [src] with \the [W].")
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/kahlua
	name = "Robert Robust's Coffee Liqueur Kahlua"
