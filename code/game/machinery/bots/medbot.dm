...
/* terrible
/obj/machinery/bot/medbot/to_bumped(atom/movable/M as mob|obj)
	spawn(0)
		if (M)
...
/obj/machinery/bot/medbot/declare()
	...
	visible_message("<span class='info'>\icon[src] Medical emergency! A patient is in critical condition at [location]!</span>")
	..()
	declare_cooldown = 1
