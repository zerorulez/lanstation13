/datum/game_mode/traitor/double_agents
	...
	restricted_jobs = list("Cyborg", "AI", "Captain", "Lieutenant", "Chief Medical Officer", "Research Director", "Chief Engineer", "Head of Security", "Mobile MMI") // Human / Minor roles only.
	required_players = 15
