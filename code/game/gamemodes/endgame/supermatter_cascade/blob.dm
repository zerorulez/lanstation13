...
/turf/unsimulated/wall/supermatter/process()
	...
	// EXPAND DONG
	if(isturf(T))
		// This is where a growth animation occurs
...
/turf/unsimulated/wall/supermatter/attack_hand(mob/user as mob)
	user.visible_message("<span class=\"warning\">\The [user] reaches out and touches \the [src]... And then blinks out of existance.</span>",\
		"<span class=\"danger\">I reach out and touch \the [src]. Everything immediately goes quiet. Your last thought is \"That was not a wise decision.\"</span>",\
...
/turf/unsimulated/wall/supermatter/to_bumped(atom/AM as mob|obj)
