...
//				message_admins("[key_name_admin(usr)] has triggered a battle to the death (only one)")
			...
			if("hellonearth")
				...
				var/choice = input("I sure you want to end the round and summon narsie at your location? Misuse of this could result in removal of flags or hilarity.") in list("PRAISE SATAN", "Cancel")
			...
			if("supermattercascade")
				...
				var/choice = input("I sure you want to destroy the universe and create a large explosion at your location? Misuse of this could result in removal of flags or hilarity.") in list("NO TIME TO EXPLAIN", "Cancel")
			...
			if("meteorstorm")
				...
				var/choice = input("Are you sure you want to summon an unending hail of meteors and force station evacuation? This will only work properly if the shuttle is not in use. Misuse of this could result in removal of flags or hilarity.") in list("BRING ME your FRIDGE", "Cancel")
				if(choice == "BRING ME your FRIDGE, WORKED FOR INDIANA JONES")
