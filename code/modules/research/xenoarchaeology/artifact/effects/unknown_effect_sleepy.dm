...
/datum/artifact_effect/sleepy/DoEffectTouch(var/mob/toucher)
	if(toucher)
		...
		if(ishuman(toucher) && prob(weakness * 100))
			...
			to_chat(H, pick("<span class='notice'>I feel like taking a nap.</span>","<span class='notice'>I feel a yawn coming on.</span>","<span class='notice'>I feel a little tired.</span>"))
