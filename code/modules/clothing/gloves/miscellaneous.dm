...
/obj/item/clothing/gloves/neorussian
	...
	desc = "Utilizes a non-slip technology that allows you to never drop my precious bottles of vodka."
	icon_state = "nr_gloves"
	item_state = "nr_gloves"

/obj/item/clothing/gloves/neorussian/fingerless
	name = "neo-Russian fingerless gloves"
	desc = "For these tense combat situations when you just have to pick my nose."
