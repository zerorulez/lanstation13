...
/*	if((P.get_species() == "Monkey" || P.get_species() == "Stok" || P.get_species() == "Farwa" || P.get_species() == "Wolpin" || P.get_species() == "Neara") && !P.mind )
		H.contract_disease(new /datum/disease/gbs/curable,1)
*/
/*
 *
 * ACTIONS
...
/datum/forbidden/action/oral/doAction(mob/living/carbon/human/H, mob/living/carbon/human/P, begins = 0)
	playsound(get_turf(P.loc), "sound/forbidden/erp/bj[rand(1, 11)].ogg", 50, 1, 0)
	..()
...
/datum/forbidden/action/fuck/doAction(mob/living/carbon/human/H, mob/living/carbon/human/P, begins = 0)
	playsound(get_turf(P.loc), "sound/forbidden/erp/bang[rand(1, 6)].ogg", 50, 1, 0)
	..()
...
/datum/forbidden/action/vagina/mount/doAction(mob/living/carbon/human/H, mob/living/carbon/human/P, begins = 0)
	if(H.virgin && !begins)
		...
		H.virgin = 0
	H.moan()
	playsound(get_turf(H.loc), "sound/forbidden/erp/bang[rand(1, 6)].ogg", 50, 1, 0)
	..()
...
// Vagina Fingering
/datum/forbidden/action/fingering/doAction(mob/living/carbon/human/H, mob/living/carbon/human/P, begins = 0)
	playsound(get_turf(P.loc), "sound/forbidden/erp/champ_fingering.ogg", 50, 1, 0)
	..()
...
/datum/forbidden/action/handjob/doAction(mob/living/carbon/human/H, mob/living/carbon/human/P, begins = 0)
	playsound(get_turf(P.loc), "sound/forbidden/erp/champ[rand(1,2)].ogg", 50, 1, 0)
	..()
