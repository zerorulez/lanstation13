...
/obj/item/weapon/gun/energy/staff/attack_self(var/mob/living/user)
	...
	var/selected = input("I squint at the dial conspicuously mounted on the side of your staff.","Staff of Change") as null|anything in list("random")+available_staff_transforms
	if(!selected)
		return
