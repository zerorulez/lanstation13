/obj/machinery/vending/mining
	...
	prices = list(
		/obj/item/clothing/accessory/holster/knife/boot/preloaded/skinning = 100,
		...
		/obj/item/weapon/mining_drone_cube = 300,
		/obj/item/weapon/pickaxe/jackhammer = 350,
		/obj/item/weapon/storage/belt/lazarus = 500,
		/obj/item/weapon/lazarus_injector = 500,
		/obj/item/weapon/resonator = 500,
		/obj/item/weapon/gun/energy/kinetic_accelerator = 650,
		/obj/item/weapon/tank/jetpack/carbondioxide = 800,
		/obj/item/weapon/gun/hookshot = 1250,
		/obj/item/weapon/lazarus_injector/advanced = 1500,
		)
