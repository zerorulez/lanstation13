...
*/
	...
	if(nutrition < 100) //Nutrition is below 100 = starvation
		...
		var/list/hunger_phrases = list(
			...
			"I haven't eaten in ages, and your body feels weak. It's time to eat something",
			"I can barely remember the last time I had a proper, nutritional meal. your body will shut down soon if I don't eat something",
		...
		switch(nutrition)
			...
			if(STARVATION_WEAKNESS to STARVATION_NOTICE) //30-60
				...
				if(prob(3)) //3% chance of a tiny amount of oxygen damage (1-10)
					...
					to_chat(src, "<span class='danger'>You are starving! The lack of strength makes me black out for a few moments...</span>")
			...
			if(STARVATION_NEARDEATH to STARVATION_WEAKNESS) //5-30, 5% chance of weakening and 1-230 oxygen damage. 5% chance of a seizure. 10% chance of dropping item
				...
				if(prob(5))
					...
					to_chat(src, "<span class='danger'>You are starving. I feel your life force slowly leaving your body...</span>")
					eye_blurry += 20
					if(knockdown < 1)
						Knockdown(20)
