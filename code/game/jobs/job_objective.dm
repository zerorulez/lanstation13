...
var/hopobjectives = pick("Require that staff take a daily exercise regiment.", "Declare that lights are a waste of company resources.", "If there is a clown on board, attempt to assign him somewhere else, this is not a time to be silly.", "Mandate that permits are required for eyewear.", "Mandate that permits are required for security equipment.", "Mandate that permits are required for satchels.", "Mandate that permits are required for spacesuits and helmets.", "Mandate that permits are required for utility belts.", "Mandate that permits are required for toolboxes.", "Mandate that permits are required for Medkits.", "Mandate that staff members must have photo identity at all times.", "Mandate that all monkeys should be used in the kitchen.", "Mandate that no monkeys should be used in the kitchen.", "I believe yourself to be the one really in command, with the Captain being a figurehead.", "The bar needs to renew its liquor license.")
			...
			var/rdobjectives = pick("Get my scientists to go on a mining expedition looking for artifacts in the asteroid field.", "Successfully enable 5 artifacts.", "\"Accidentally\" release Lamarr.", "Play around with my fancy scientific generator.", "Keep an eye on the borgs and prevent them from going rogue.")
			...
			var/ceobjectives = pick("Teach my engineers how to do atmospheric piping.", "Teach my engineers how to do disposal piping.", "Teach my engineers how to do wiring.", "Teach my engineers how to hack doors and machines.", "Successfully put together an airlock without the use of an RCD.", "Teach my engineers how to turn on and maintain the engine.", "Hire a mime to work for R&D.", "Acquire a clowns horn and offer it to R&D to do research on.")
			var/aiobjectives = pick("Attempt to 'Woo' the Captain.", "Refer to the captain as HORSE RUMPS.", "Make note that clowns are just as important as Captains by the laws of robotics", "Request a spacesuit so that you can sound like a computer.", "Give relationship advice to anyone who speaks to you.", "I am the ship psychologist.  Give advice to the crew.", "I do not have to do anything for anyone unless they say \"please\".") //Basically be a fucking doorknob, I can't think of any objectives for the AI.

			//Assistant/Bullshit Jobs
			var/assistantobjectives = pick("Get a haircut.", "Get a real job.", "Don't be a slob.", "Start my own business.", "Become a salesman.","Befriend a clown.", "Convince a mime to speak.")
			var/touristobjectives = pick("Take pictures of all the things. All of them.", "Befriend a clown.", "Convince a mime to speak.", "Get hired on the station.", "Become an assistant.", "Escape with my camera.")
			var/clownobjectives = pick("I am a mouse.", "Grunt ominously whenever possible.", "Epilepsy is fun, flicker lights whenever you can!", "My name is Joe 6-pack.", "Refer to humans as puppies.", "Insult heads of staff on every request, while acquiescing.", "Advertise parties in my office, but don't deliver.", "Prevent non-dwarves from operating the power core.", "The ship needs elected officials.", "Only bearded people are human.", "Turn on the microphone on every intercom you see.", "Wrench is a lightbulb.", "Toolbox is a medkit.", "Everyone is wearing a pretty pink dress!", "The monkeys are plotting a hostile takeover of the ship. Inform the crew, and get them to take action against this", "Refer to the captain as \"Princess\" at all times.", "The crew must construct additional pylons.", "I must always lie.", "All answers must be in the form of a question.", "The station is an airplane.", "Happiness is mandatory.", "Today is laundry day.", "The word \"it\" is painful to you.", "I must act passive aggressively.", "Crew ranks have been reversed.", "It's Friday.", "It's backwards day.", "Give relationship advice to anyone who speaks to you.", "I am the ship psychologist.  Give advice to the crew.", "I do not have to do anything for anyone unless they say \"please\"." )
			var/mimeobjectives = pick("...", "...", "...", "...", "...", "...", "<span class='warning'>The narrator appears to try gesturing my objective to you, but fails miserably.</span>")
			var/chaplainobjectives = pick("Convert at least three other people to my religion..", "Hold a proper space burial.", "Build a shrine to my deity.", "Collect Ð18 in donations.", "Start a cult.", "Get someone to confess.", "Do my own radio show over the intercoms and accept calls.")

			//Civilian Jobs
			var/bartenderobjectives = pick("Make 10 successful coctails.", "Make a gargle blaster.", "Hack the vending machine and acquire robusters delight.", "Stop people from having bar fights over the jukebox.", "Prevent people from getting to the jukebox.", "Make doctors delight.", "Put out as many drinks in the bar as you can.", "Attempt to get the whole crew to come to the bar and get drunk.", "Shoot the clown with my shotgun.", "Start selling cigarettes.", "Win on the space arcade.", "Tell stories to the crew while drunk.", "Attempt to redecorate my bar.")
			var/chefobjectives = pick("Sell my food", "Successfully make 10 unique dishes.", "Gather all the monkeys on the station just to get meat from them.", "Say \"BORK BORK BORK\" after every few sentences.", "Use my blender to make unique drinks out of food.", "Get the botanist to harvest vegetables and fruits for you.", "Make an assburger.", "Make a penisburger.", "Make a clown burger.", "Call failed dishes salads.", "Keep my kitchen clean.")
			...
			var/roboticistobjectives = pick("Build a Medibot of every color", "Give custom names to each of my special little creations", "Outclass the janitor by making 5 Clean-bots spread through the ship", "Outclass security by making 4 securitrons and 1 ED209")
			var/detectiveobjectives = pick("Monologue at every chance regardless of if you have listeners.", "Track down leads.", "Snoop on the scientists.", "Snoop on the doctors.", "Snoop on the engineers.", "Snoop on the security staff.", "Snoop on the Captain.", "Snoop on the Lieutenant.")
			...
			var/botanistobjectives = pick("Grow food.", "Grow illegal drugs.", "Grow cannabis", "Smoke cannabis.", "Hack my seed machine.", "Make plantmen.", "Become a drug dealer.", "Deliver fruit and vegetables to the chef.", "Keep my plants free from pests.", "Grow killer tomatos.", "Grow walking mushrooms.", "Find people to get high with.")
			...
			var/scientistobjectives = pick("Go on an asteroid field to look for artifacts.", "Successfully enable 5 artifacts.", "Attempt to release Lamarr.", "Play around with my fancy scientific generator.", "Attempt to make a bomb.", "Research objects for high levels on the R&D console.", "Research alien artifacts.", "Feed the metroids regurarly.", "Make a successful bomb and detonate it in the testing chamber.", "Deconstruct every item on the station.")
*/