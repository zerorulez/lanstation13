...
var/eventTimeLower = 4200	//7 minutes
var/eventTimeUpper = 9000	//15 minutes
...
/proc/checkEvent()
	if(!scheduledEvent)
		...
		switch(player_list.len)
			...
			if(31 to 40)
				playercount_modifier = 0.95 //"Medium value"
			if(41 to 50)
			...
			if(81 to INFINITY)
				playercount_modifier = 0.70 //At this point it's icing on the cake
		...
		switch(world.time)
			...
			if(36001 to INFINITY) //Round has been going for 1 hour minutes at least
