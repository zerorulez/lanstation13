 ...
 */
	...
	send2mainirc("@everyone, **server starting up** on `[config.server? "byond://[config.server]" : "byond://[world.address]:[world.port]"]`. Map is **[map.nameLong]**.")
...
*/
	...
	to_chat(world, "<b>Estação abandonada.</b>")
