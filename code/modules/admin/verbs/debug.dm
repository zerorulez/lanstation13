...
/client/proc/cmd_admin_dress(var/mob/living/carbon/human/M in mob_list)
	...
	switch(dresscode)
		...
		if ("tournament gangster") //gangster are supposed to fight each other. --rastaf0
			...
			M.equip_to_slot_or_del(new /obj/item/clothing/glasses/scanner/thermal/monocle(M), slot_glasses)
		...
		if("special ops officer")
			...
			M.equip_to_slot_or_del(new /obj/item/device/radio/headset/heads/captain(M), slot_ears)
			M.equip_to_slot_or_del(new /obj/item/clothing/glasses/scanner/thermal/eyepatch(M), slot_glasses)
