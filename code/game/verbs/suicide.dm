...
/mob/living/carbon/human/verb/suicide()
	...
	if(stat == DEAD)
		to_chat(src, "<span class='warning'>You are already dead!</span>")
		return
	...
	if(suiciding)
		to_chat(src, "<span class='warning'>You are already committing suicide! Be patient!</span>")
		return
...
/mob/living/carbon/monkey/verb/suicide()
	...
	var/mob/living/simple_animal/borer/B=has_brain_worms()
	if (B && B.controlling) // Borer
		to_chat(src, "My can't suicide while controlling your host, you dick.")
		return
