...
/datum/surgery_step/generic/cut_with_laser/begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	"I start the bloodless incision on [target]'s [affected.display_name] with \the [tool].")
	target.custom_pain("I feel a horrible, searing pain in my [affected.display_name]!",1)
	..()
...
/datum/surgery_step/generic/cut_with_laser/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	"<span class='notice'>I have made a bloodless incision on [target]'s [affected.display_name] with \the [tool].</span>",)
	//Could be cleaner ...
	affected.open = 1
...
/datum/surgery_step/generic/cut_with_laser/fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	"<span class='warning'>My hand slips as the blade sputters, searing a long gash in [target]'s [affected.display_name] with \the [tool]!</span>")
...
/datum/surgery_step/generic/incision_manager/begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	"I start to construct a prepared incision on and within [target]'s [affected.display_name] with \the [tool].")
	target.custom_pain("I feel a horrible, searing pain in my [affected.display_name] as it is pushed apart!",1)
...
/datum/surgery_step/generic/incision_manager/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	"<span class='notice'>I have constructed a prepared incision on and within [target]'s [affected.display_name] with \the [tool].</span>",)
	affected.open = 1
	affected.status |= ORGAN_BLEEDING
	affected.createwound(CUT, 1)
	affected.clamp()
...
/datum/surgery_step/generic/incision_manager/fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	"<span class='warning'>My hand jolts as the system sparks, ripping a gruesome hole in [target]'s [affected.display_name] with \the [tool]!</span>")
...
/datum/surgery_step/generic/cut_open/begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	"I start the incision on [target]'s [affected.display_name] with \the [tool].")
	target.custom_pain("I feel a horrible pain as if from a sharp knife in my [affected.display_name]!",1)
	..()
...
/datum/surgery_step/generic/cut_open/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	"<span class='notice'>I have made an incision on [target]'s [affected.display_name] with \the [tool].</span>",)
	affected.open = 1
	affected.status |= ORGAN_BLEEDING
	affected.createwound(CUT, 1)
...
/datum/surgery_step/generic/cut_open/fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	"<span class='warning'>My hand slips, slicing open [target]'s [affected.display_name] in the wrong place with \the [tool]!</span>")
...
/datum/surgery_step/generic/clamp_bleeders/begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	"I start clamping bleeders in [target]'s [affected.display_name] with \the [tool].")
	target.custom_pain("The pain in my [affected.display_name] is maddening!",1)
	..()
...
/datum/surgery_step/generic/clamp_bleeders/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	"<span class='notice'>I clamp bleeders in [target]'s [affected.display_name] with \the [tool].</span>")
	affected.clamp()
...
/datum/surgery_step/generic/clamp_bleeders/fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	"<span class='warning'>My hand slips, tearing blood vessels and causing massive bleeding in [target]'s [affected.display_name] with \the [tool]!</span>",)
	affected.createwound(CUT, 10)
...
/datum/surgery_step/generic/retract_skin/begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	var/self_msg = "I start to pry open the incision on [target]'s [affected.display_name] with \the [tool]."
	if (target_zone == LIMB_CHEST)
		msg = "[user] starts to separate the ribcage and rearrange the organs in [target]'s torso with \the [tool]."
		self_msg = "I start to separate the ribcage and rearrange the organs in [target]'s torso with \the [tool]."
	if (target_zone == LIMB_GROIN)
		msg = "[user] starts to pry open the incision and rearrange the organs in [target]'s lower abdomen with \the [tool]."
		self_msg = "I start to pry open the incision and rearrange the organs in [target]'s lower abdomen with \the [tool]."
	user.visible_message(msg, self_msg)
	target.custom_pain("It feels like the skin on my [affected.display_name] is on fire!",1)
	..()
...
/datum/surgery_step/generic/retract_skin/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	var/self_msg = "<span class='notice'>I keep the incision open on [target]'s [affected.display_name] with \the [tool].</span>"
	if (target_zone == LIMB_CHEST)
		msg = "<span class='notice'>[user] keeps the ribcage open on [target]'s torso with \the [tool].</span>"
		self_msg = "<span class='notice'>I keep the ribcage open on [target]'s torso with \the [tool].</span>"
	if (target_zone == LIMB_GROIN)
		msg = "<span class='notice'>[user] keeps the incision open on [target]'s lower abdomen with \the [tool].</span>"
		self_msg = "<span class='notice'>I keep the incision open on [target]'s lower abdomen with \the [tool].</span>"
	user.visible_message(msg, self_msg)
	affected.open = 2
...
/datum/surgery_step/generic/retract_skin/fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	var/self_msg = "<span class='warning'>My hand slips, tearing the edges of the incision on [target]'s [affected.display_name] with \the [tool]!</span>"
	if (target_zone == LIMB_CHEST)
		msg = "<span class='warning'>[user]'s hand slips, damaging several organs in [target]'s torso with \the [tool]!</span>"
		self_msg = "<span class='warning'>My hand slips, damaging several organs in [target]'s torso with \the [tool]!</span>"
	if (target_zone == LIMB_GROIN)
		msg = "<span class='warning'>[user]'s hand slips, damaging several organs in [target]'s lower abdomen with \the [tool]</span>"
		self_msg = "<span class='warning'>My hand slips, damaging several organs in [target]'s lower abdomen with \the [tool]!</span>"
	user.visible_message(msg, self_msg)
...
/datum/surgery_step/generic/cauterize/begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	"I am beginning to cauterize the incision on [target]'s [affected.display_name] with \the [tool].")
	target.custom_pain("My [affected.display_name] is being burned!",1)
	..()
...
/datum/surgery_step/generic/cauterize/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	"<span class='notice'>I cauterize the incision on [target]'s [affected.display_name] with \the [tool].</span>")
	affected.open = 0
...
/datum/surgery_step/generic/cauterize/fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	"<span class='warning'>My hand slips, leaving a small burn on [target]'s [affected.display_name] with \the [tool]!</span>")
...
/datum/surgery_step/internal/fix_organ_cancer/begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	if(affected && affected.cancer_stage >= 1)
		...
		"I start carefully removing the cancerous growths in [target]'s [affected.name] with \the [tool]." )

	target.custom_pain("The pain in my [affected.display_name] is living hell!", 1)
	..()
...
/datum/surgery_step/internal/fix_organ_cancer/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	if(affected && affected.cancer_stage >= 1)
		...
		"I carefully remove and mends the area around the cancerous growths in [target]'s [affected.name] with \the [tool]." )
...
/datum/surgery_step/internal/fix_organ_cancer/fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	"<span class='warning'>My hand slips, getting mess in and tearing the inside of [target]'s [affected.display_name] with \the [tool]!</span>")
	affected.createwound(CUT, 10)
*/
...
/datum/surgery_step/generic/cut_limb/begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	"I am beginning to cut off [target]'s [affected.display_name] with \the [tool].")
	target.custom_pain("My [affected.display_name] is being ripped apart!",1)
	..()
...
/datum/surgery_step/generic/cut_limb/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	"<span class='notice'>I cut off [target]'s [affected.display_name] with \the [tool].</span>")
...
/datum/surgery_step/generic/cut_limb/fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	"<span class='warning'>My hand slips, sawing through the bone in [target]'s [affected.display_name] with \the [tool]!</span>")
