		...
		if (reagents.reagent_list.len > 0)
			...
			switch(reagents.get_master_reagent_id())
				...
				if(HOOCH)
					...
					name = "\improper Hooch"
					desc = "I've really hit rock bottom now... your liver packed its bags and left last night."
				if(WHISKEYSODA)
		...
		if (reagents.reagent_list.len > 0)
			...
			switch(reagents.get_master_reagent_id())
				...
				if(DETCOFFEE)
					...
					name = "Joe"
					desc = "The lights, the smoke, the grime, the station itself felt alive that day as I stepped into your office, mug in hand. It was another one of those days. Some Nurse got smoked in one of the tunnels, and it came down to me to catch the guy did it. I got up to close the blinds of your office, when an officer burst through your door. There had been another one offed in the tunnels, this time an assistant. I grumbled and downed some of your joe. It was bitter, tasteless, but it was what kept me going. I remember back when I was a rookie, this stuff used to taste so great to me. I guess that's just another sign of how this station changes people. I put your mug back down on your desk, dusted off your jacket, and lit your last cigar. I checked to make sure your faithful revolver was loaded, and stepped out, back into the cold halls of the station."
				if(ETANK)
					icon_state = ETANK
					name = "Recharger"
